# A Dataframe with 'main_sectors' mapped for each company - tail(master_data1)
...
filtered_data <- master_data1[
      which(master_data1$funding_round_type == suitable_investment_type$funding_round_type),]
...
D3_top_sector_count_based <- head(D3_count_funding,3)
